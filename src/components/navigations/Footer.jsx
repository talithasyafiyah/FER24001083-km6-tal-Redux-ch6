    ...
    <footer className="main-font mt-[50px] bg-main">
      <div className="w-full p-4 py-8">
        <div className="flex items-center justify-between md:container md:mb-8">
          ...
          <div className="mb-6 md:mb-0">
            <ul className="flex flex-row space-x-3 text-sm text-white md:p-0 lg:p-0">
              <li>
                <div className="rounded-full bg-white bg-opacity-15 p-1 md:p-2 cursor-pointer">
                  <svg
                    className="h-3 w-3 fill-white hover:fill-primary md:h-4 md:w-4"
        ...
        <div className="main-font justify-center md:container md:justify-between lg:flex">
          <div className="md:mb-8 lg:mb-0">
            <ul className="flex flex-row text-center text-xs text-white md:space-x-7 md:p-0 md:text-sm lg:space-x-8 lg:p-0">
              <li>
                <a
                  href="#"
